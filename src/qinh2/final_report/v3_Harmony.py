...
def transaction_v3_Harmony():
    transaction = pyreadr.read_r("/data/IDEA_DeFi_Research/Data/Lending_Protocols/Aave/V3/Harmony/transactions.rds")
    df = transaction[None]
...
dailyTransactionCount_v3_Harmony = transaction_v3_Harmony()
feature_train, feature_test, target_train, target_test = data_split(dailyTransactionCount_v3_Harmony)
