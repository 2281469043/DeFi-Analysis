...
plt.show()
'''
Combine DateTime in the same day together, and then i add their label(amount)together to draw a curve graph,
Y_axis is amount, X_axis is Datetime.
FE: DateTime 2021-07-01 11:46:58, amount 1 and DateTime 2021-07-01 12:46:58, 
amount 2 All belong to 2021-07-01, so i will add 1 and 2 together to draw the curve graph.
'''
