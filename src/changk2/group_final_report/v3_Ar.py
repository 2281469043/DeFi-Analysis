...
def transaction_v3_Arbitrum():
    transaction = pyreadr.read_r("/data/IDEA_DeFi_Research/Data/Lending_Protocols/Aave/V3/Arbitrum/transactions.rds")
    df = transaction[None]
...
feature_train, feature_test, target_train, target_test = data_split(dailyTransactionCount_v3_Arbitrum)
